...
python_configure_all() {
	...
	# Fixed in 1.13.0
	filter-lto
	ewarn flang is not good at doing anything, try `ebuild me merge` multiple times...
	DISTUTILS_ARGS=(
		-Dblas=blas
		-Dlapack=lapack
		-Duse-pythran=$(usex fortran true false)
		# TODO: enable Accelerate when feasible
		# see https://github.com/scipy/scipy/blob/main/doc/source/building/index.rst
		# currently there is "symbol not found things"
	)
}
