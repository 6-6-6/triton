...
FFMPEG_FLAG_MAP=(
		...
		fribidi:libfribidi fontconfig ladspa lcms:lcms2 libass libplacebo2:libplacebo libtesseract lv2
...
RDEPEND="
	...
	libplacebo2? ( >=media-libs/libplacebo-4.192.0:=[$MULTILIB_USEDEP] )
